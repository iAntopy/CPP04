...
/*   Updated: 2023/03/24 20:08:57 by iamongeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::ostream&	operator<<(std::ostream& o, WrongAnimal const& a)
{
	if (a.getType().empty())
		...
		o << "This is a WrongAnimal of type : " << a.getType() << std::endl;
	return (o);
}
...
WrongAnimal::WrongAnimal(std::string const& typeName) : type(typeName) {
	std::cout << "Typed WrongAnimal constructor called." << std::endl;}
...
void	WrongAnimal::makeSound(void) const {
	std::cout << this->getType() << " lets a fart loose on the wrong terf and accidently\
